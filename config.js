System.config({
  ...
  map: {
    ...
    "npm:babel-core@6.1.2": {
      "babel-code-frame": "npm:babel-code-frame@6.0.15",
      "babel-generator": "npm:babel-generator@6.1.2",
      "babel-helpers": "npm:babel-helpers@6.1.2",
      "babel-messages": "npm:babel-messages@6.0.15",
      "babel-runtime": "npm:babel-runtime@5.8.29",
      "babel-template": "npm:babel-template@6.0.16",
      "babel-traverse": "npm:babel-traverse@6.1.2",
      "babel-types": "npm:babel-types@6.1.2",
      "babylon": "npm:babylon@6.1.2",
